...
> PalPeek 只提供观战，不提供远程控制。当前版本为 **0.2.0**，仅支持 **Windows 11 x64**。
...
- 当前串流画质默认为 720p60 / 4 Mbps；协议同时支持 1080p60 / 8 Mbps。
...
- 当前用户界面使用固定的默认画质 720p60 / 4 Mbps；1080p60 / 8 Mbps 已由协议支持，但尚未在设置页开放选择。
